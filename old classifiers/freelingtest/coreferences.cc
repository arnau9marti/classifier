...
int main (int argc, char **argv) {
  ...
  dep_treeler treeler(path+L"treeler/dependences.dat");
  // create a coreference solver
  relaxcor coref(path+L"coref/relaxcor_constit/relaxcor.dat");
  //relaxcor coref(path+L"coref/relaxcor_dep/relaxcor.dat");
